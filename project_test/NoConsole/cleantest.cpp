...
LRESULT CALLBACK AttendanceWndProc(HWND hWnd, UINT msg, WPARAM wp, LPARAM lp)
{
    ...
    static vector<wstring> studentNames, studentRollNos, studentBatchNos, studentAttendance, studentData;
    ...
    case WM_CREATE: {
        ...
        hListView = CreateWindowW(WC_LISTVIEWW, NULL, WS_VISIBLE | WS_CHILD | LVS_REPORT | LVS_SINGLESEL, 50, 300, 600, 200, hWnd, (HMENU)100, GetModuleHandleW(NULL), NULL);
